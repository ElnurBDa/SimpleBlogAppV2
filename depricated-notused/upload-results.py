...
def upload_results(host, api_key, scanner, result_file, engagement_id, lead_id, environment,test_title, verify=False): # set verify to False if ssl cert is self-signed
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_title', help="Test title", required=True)
    ...
    result = upload_results(host, api_key, scanner, result_file, engagement_id, lead_id, environment,test_title)
    if result == 201 :
